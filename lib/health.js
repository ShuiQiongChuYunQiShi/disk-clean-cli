...
function appendHistory(disks) {
  try {
    ...
    disks.forEach(function(d){
      ...
      hist[key].push({ ts: now, temp: d.temp, wear: d.wear, poh: d.poh, readErrUncorr: d.readErrUncorr, writeErrUncorr: d.writeErrUncorr, readErrCorr: d.readErrCorr, writeErrCorr: d.writeErrCorr });
