...
> 状态：**规划完成、等确认后开工** ｜ 目标版本 **v0.4.1**（安全修复 + 功能增强的安全迭代，非破坏性大版本）｜ 前版 v0.4.0 已发布
...
> 状态：**已完成**（2026-08-25 决策 → 本轮执行完毕，代码与文档同步，9/9 测试绿，端到端实测通过）
...
- [x] `node test/all.js` 9/9 全绿（含 MCP 协议测试、版本一致性；危险用例默认跳过）
